 ...
 */
test.describe("TC_Additional_Details_01_Verify_that_the_Timestamps_display_Information_Received_as_a_most_outstanding_feature", () => {
	test("should verify that the Timestamps display Information Received as a most outstanding feature", async () => {
		...
		const selectMerchantPage =
			await portalPage.signInWithUsernameAndPassword(nonPPUser);
